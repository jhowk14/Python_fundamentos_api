"""
  ...
  Objetivos:
  Nesta atividade você vai calcular uma folha de pagamento usando o comando 
  if aninhado e mostrando o resultado dos valores de Imposto de Renda e INSS a serem pagos.
